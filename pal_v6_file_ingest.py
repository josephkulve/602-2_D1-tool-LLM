...
#
# Bash examples:
#   python pal_v6_file_ingest.py ingest '{"entity":"truck_17","event_type":"shipment","location":"taipei","status":"delayed","note":"flat tire"}'
#   python pal_v6_file_ingest.py plan "Compare delayed shipments in Taipei vs blocked shipments in Tainan"
#   python pal_v6_file_ingest.py plan "Compare truck_17 with truck_22"
#   python pal_v6_file_ingest.py plan "Analyze delayed events in Taipei and compare them with all events in Kaohsiung"
#
# Requirements:
#   pip install openai
...
def print_usage() -> None:
    print(
        "Usage:\n"
        "  python pal_v6_file_ingest.py ingest_file <path_to_jsonl>\n"
        "  python pal_v6_file_ingest.py ingest '<json_event>'\n"
        "  python pal_v6_file_ingest.py analyze\n"
        "  python pal_v6_file_ingest.py query '<json_filter>'\n"
        "  python pal_v6_file_ingest.py ask '<natural language query>'\n"
        "  python pal_v6_file_ingest.py plan '<natural language analysis request>'\n\n"
        "Bash examples:\n"
        '  python pal_v6_file_ingest.py ingest \'{"entity":"truck_17","event_type":"shipment","location":"taipei","status":"delayed","note":"flat tire"}\'\n'
        '  python pal_v6_file_ingest.py ask "show delayed events in taipei"\n'
        '  python pal_v6_file_ingest.py plan "Compare delayed shipments in Taipei vs blocked shipments in Tainan"\n'
        '  python pal_v6_file_ingest.py plan "Compare truck_17 with truck_22"\n'
    )
